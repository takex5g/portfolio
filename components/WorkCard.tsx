    ...
    <div className="rounded-sm overflow-hidden h-full">
      <div className="w-full h-full relative overflow-hidden group">
        ...
        >
          ...
          />
          <div className="absolute inset-x-1 bottom-0 px-1 pt-1 bg-white/60 translate-y-[calc(100%-2.5rem)] transition-transform duration-300 group-hover:translate-y-0">
